            ...
            <div id="sidebar-alt-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="chat-talk display-none">
                        ...
                        <!-- Chat Input -->
                        <form action="{{url('/home')}}" method="post" id="sidebar-chat-form" class="chat-form">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{url('backend/all_events')}}">All events</a>
                                </li>
                                <li>
                                    <a href="page_ecom_order_view.html">Event View</a>
                                </li>
                                <li>
